...
export const env = createEnv({
  ...
  server: {
    ...
    TELLER_INTERVAL_IN_DAYS: z.coerce.number().optional(),
  ...
  runtimeEnv: {
    ...
    TELLER_ENVIRONMENT: process.env.TELLER_ENVIRONMENT,
    TELLER_CERT_PATH: process.env.TELLER_CERT_PATH,
    TELLER_KEY_PATH: process.env.TELLER_KEY_PATH,
    TELLER_INTERVAL_IN_DAYS: process.env.TELLER_INTERVAL_IN_DAYS,
